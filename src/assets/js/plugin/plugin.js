  ...
  jQuery(document).ready(function () {
    ...
    $('.browse-games-carousel')
      ...
      .slick({
        ...
        arrows: true,
        prevArrow:
          "<button type='button' class='arafat-prev cmn-btn pull-left'><i class=\"icon-d-arrow-thin\"  aria-hidden='true'></i></button>",
        nextArrow:
          "<button type='button' class='arafat-next cmn-btn pull-right'><i class=\"icon-d-arrow-thin\"  aria-hidden='true'></i></button>",
        dots: false,
    ...
    if (document.querySelector('.owl-carousel') !== null) {
      $('.owl-carousel').owlCarousel({
        ...
        nav: true,
        navText: [
          "<span class='cmn-btn alt'><i class='fa fa-chevron-left'></i></span>",
          "<span class='cmn-btn alt'><i class='fa fa-chevron-right'></i></span>"
        ],
        navigation: true,
        responsive: {
          0: {
